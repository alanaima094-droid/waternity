    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage tariffs, monitor devices, and handle withdrawals</p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <select 
                    ...
                    onChange={(e) => setSelectedWell(mockWells.find(w => w.id === e.target.value) || mockWells[0])}
                  >
                    {mockWells.map(well => (
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-1 text-sm">
                    <div className="flex justify-between">
                      <span>Base Rate:</span>
                      <span className="font-mono">${selectedWell.pricePerLiter}/L</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Monthly Volume:</span>
                      <span className="font-mono">{selectedWell.monthlyVolume.toLocaleString()}L</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Revenue (30d):</span>
                      <span className="font-mono text-green-600">
                        ${(selectedWell.monthlyVolume * selectedWell.pricePerLiter).toLocaleString()}
                      </span>
                    </div>
                  </div>
                </div>

                <Button className="w-full" onClick={() => toast.success('Tariff updated successfully (mock)')}>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Performance metrics and projections</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-green-50 p-4 rounded-lg">
                      <div className="text-2xl font-bold text-green-600">
                        ${(selectedWell.monthlyVolume * selectedWell.pricePerLiter * 12).toLocaleString()}
                      </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-semibold">
                        ${(selectedWell.monthlyVolume * 0.95 * selectedWell.pricePerLiter).toLocaleString()}
                      </span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span>Growth:</span>
                      <span className="font-semibold text-green-600">+5.3%</span>
                    </div>
                  </div>
                </div>
              </CardContent>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <CardContent>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                  <div className="bg-green-50 p-4 rounded-lg text-center">
                    ...
                    <div className="text-2xl font-bold">{deviceData.battery}%</div>
                    <div className="text-xs text-muted-foreground">Battery</div>
                  </div>
                  <div className="bg-blue-50 p-4 rounded-lg text-center">
                    <Signal className="w-6 h-6 mx-auto mb-2 text-blue-600" />
                    <div className="text-2xl font-bold">{deviceData.signal}/5</div>
                    <div className="text-xs text-muted-foreground">Signal</div>
                  </div>
                  <div className="bg-orange-50 p-4 rounded-lg text-center">
                    <Thermometer className="w-6 h-6 mx-auto mb-2 text-orange-600" />
                    <div className="text-2xl font-bold">{deviceData.temperature}°C</div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                    ...
                    <span className="font-mono">{deviceData.totalVolume.toLocaleString()}L</span>
                  </div>
                </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Device control and maintenance</CardDescription>
              </CardHeader>
              <CardContent className="space-y-3">
                <Button variant="outline" className="w-full justify-start" onClick={() => toast.info('Device logs downloaded (mock)')}>
                  <Download className="w-4 h-4 mr-2" />
                  Download Logs
                </Button>
                <Button variant="outline" className="w-full justify-start" onClick={() => toast.success('Firmware uploaded (mock)')}>
                  <Upload className="w-4 h-4 mr-2" />
                  Upload Firmware
                </Button>
                <Button variant="outline" className="w-full justify-start" onClick={() => toast.warning('Device restarted (mock)')}>
                  <Zap className="w-4 h-4 mr-2" />
                  Restart Device
                </Button>
                <Button variant="outline" className="w-full justify-start" onClick={() => toast.message('Maintenance scheduled (mock)')}>
              ...
              <div className="space-y-4">
                {alerts.map((alert) => (
                  <div key={alert.id} className="flex items-start gap-4 p-4 border rounded-lg">
                    ...
                    <Button variant="outline" size="sm" onClick={() => toast.info('Alert marked as resolved (mock)')}>
                      Resolve
                    </Button>
                  </div>
                ))}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="bg-green-50 p-4 rounded-lg">
                  <div className="text-2xl font-bold text-green-600">
                    ${(selectedWell.monthlyVolume * selectedWell.pricePerLiter * 0.7).toLocaleString()}
                  </div>
                ...
                <Button className="w-full" disabled={!withdrawAmount} onClick={() => toast.success('Withdrawal request submitted (mock)')}>
                  Request Withdrawal
                </Button>
                  ...
                  {recentWithdrawals.map((withdrawal, index) => (
                    <div key={index} className="flex items-center justify-between p-3 border rounded-lg">
                      ...
                      <Badge 
                        ...
                        className={withdrawal.status === 'completed' ? 'bg-green-50 text-green-700' : ''}
                      >
                        {withdrawal.status}
                      </Badge>
                    </div>
